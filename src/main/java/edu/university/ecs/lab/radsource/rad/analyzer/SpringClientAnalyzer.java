 ...
 * It uses {@link edu.university.ecs.lab.radsource.rad.dataflow.LocalVariableScanner} to detect the url.
 * It constructs a list of {@link edu.university.ecs.lab.radsource.rad.model.RestEntity} of rest clients.
 *
 * @author Dipta Das
 */
