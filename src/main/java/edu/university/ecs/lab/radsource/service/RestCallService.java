...
import edu.university.ecs.lab.radsource.model.RestTemplateMethod;
...
public class RestCallService {
  ...
  private void resolveReturnType(
      ...
      CompilationUnit cu,
      MethodCallExpr mce,
      RestTemplateMethod restTemplateMethod) {
  ...
  private String resolveUrlFromBinaryExp(BinaryExpr exp) {
    // this handles cases in the form of "some/path/here/" + someExpression + "/"
    // someOtherExpression, or just
    // "some/path/here/" + someExpression
    String trailer =
        exp.getRight().toString().equals("/") || exp.getRight().toString().equals("\"/\"")
            ? ""
            : "{var}";
