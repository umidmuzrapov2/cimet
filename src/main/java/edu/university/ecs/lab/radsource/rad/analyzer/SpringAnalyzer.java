...
import edu.university.ecs.lab.radsource.rad.model.Param;
...
/**
 * This class performs Spring Boot RestController annotation analysis. It constructs a list of
 * {@link edu.university.ecs.lab.radsource.rad.model.RestEntity} of rest endpoints.
 *
 * @author Dipta Das
 */
@Component
    ...
    if (annotationsAttribute != null) {
      ...
      for (Annotation annotation : annotations) {
        ...
        if (annotationType.equals(getSpringAnnotation("RequestMapping"))) {
          ...
          if (Helper.getAnnotationValue(annotation, "method") != null) {
            restEntity.setHttpMethod(
                annotationToHttpMethod(Helper.getAnnotationValue(annotation, "method")));
          }
          if (Helper.getAnnotationValue(annotation, "produces") != null) {
          ...
          if (Helper.getAnnotationValue(annotation, "value") != null) {
            ...
            restEntity.setPath(
                Helper.getAnnotationValue(annotation, "path")); // path is alias for value
          }
