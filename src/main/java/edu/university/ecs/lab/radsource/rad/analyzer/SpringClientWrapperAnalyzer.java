...
/**
 * This class detects Spring Boot RestTemplate client calls. It can detect the return type of a rest
 * call using return type of the wrapper method. It can not detect the url of a rest call. It
...
public class SpringClientWrapperAnalyzer {
  ...
  private static final String ribbonClientAnnotation =
          ...
          new ExprEditor() {
            public void edit(MethodCall m) {
              for (RestTemplateMethod targetMethod : restTemplateMethods) {
                if (m.getClassName().equals(restTemplateClass)
                    && m.getMethodName().equals(targetMethod.restTemplateMethod)) {
