...
/**
 * This class performs JAX RS annotation analysis and micro-profile client analysis. It constructs a
 * list of {@link edu.university.ecs.lab.radsource.rad.model.RestEntity}.
 *
 * @author Dipta Das
 */
@Component
public class JaxRsAnalyzer {
  ...
  static final String mpRegisterControllerAnnotation =
