package edu.university.ecs.lab.radsource.rad.service;
...
/**
 * The ResourceService service exposes many helper methods for managing loading resources from the
 * files contained within a jar. The service exposes three methods for public use, {@link
 * edu.university.ecs.lab.radsource.rad.service.ResourceService#getResourcePaths(String)}, {@link
 * edu.university.ecs.lab.radsource.rad.service.ResourceService#getProperties(String, String)} and
 * {@link edu.university.ecs.lab.radsource.rad.service.ResourceService#getCtClasses(String,
 * String)}.
 *
 * @author Jan Svacina
 * @version 1.1
...
public class ResourceService {
  ...
  /**
   * Constructor for {@link edu.university.ecs.lab.radsource.rad.service.ResourceService} which
   * injects a {@link ResourceLoader}
   *
  ...
  /**
   * This method returns a {@link List} of {@link String} objects, each of which represents a JAR or
   * WAR file in the prject directory to be analyzed. This method is an entry point for the {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService}.
   *
   * @param folderPath the root folder of the project which contains the microservices
   * @return a {@link List} of {@link String} objects, each of which represents a JAR or WAR file in
   *     the prject directory to be analyzed
   */
   ...
   * files from the microservice. This method is an entry point for the {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService}.
   *
   * @param jarPath the path to the JAR file
   * @param organizationPath the package of the project to ensure we only get project config files
   * @return a {@link Set} of {@link Properties} objects loaded from the properties files from the
   *     microservice
   */
  ...
  /**
   * This method returns a {@link List} of {@link CtClass} objects loaded from a particular JAR
   * file. This method is an entry point for the {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService}.
   *
  ...
  /**
   * This method returns a {@link Resource} from a file path loaded by the injected {@link
   * ResourceLoader}. This is a private helper method used by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getProperties(String, String)} and
   * by {@link edu.university.ecs.lab.radsource.rad.service.ResourceService#getCtClasses(String,
   * String)}.
   *
  ...
  /**
   * This method constructs a {@link Set} of {@link ClassFile} objects from the loaded JAR file.
   * This is a private helper method used by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getCtClasses(String, String)}.
   *
   ...
   * helper method used by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getProperties(String, String)} and
   * by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getClassFileSet(Resource,
   * String)}.
   *
  ...
  /**
   * This method constructs a {@link URI} from a given {@link String}. This is a private helper
   * method used by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getProperties(String, String)} and
   * by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getClassFileSet(Resource,
  ...
  /**
   * This method returns if a {@link JarEntry} is a class file. This is a private helper method used
   * by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getClassFileSet(Resource,
   * String)}.
   *
  ...
  /**
   * This method returns if a {@link JarEntry} is a properties file. This is a private helper method
   * used by {@link
   * edu.university.ecs.lab.radsource.rad.service.ResourceService#getClassFileSet(Resource,
   * String)}.
   *
