...
/**
 * This class wraps the resource path with a list of {@link
 * edu.university.ecs.lab.radsource.rad.model.RestEntity} resulted after performing the REST API
 * discovery analysis for that specific resource.
 *
 * @author Dipta Das
 */
@Getter
