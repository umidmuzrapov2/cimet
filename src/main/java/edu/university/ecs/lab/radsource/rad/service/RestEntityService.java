...
import edu.university.ecs.lab.radsource.rad.analyzer.Helper;
import edu.university.ecs.lab.radsource.rad.analyzer.JaxRsAnalyzer;
import edu.university.ecs.lab.radsource.rad.analyzer.SpringAnalyzer;
import edu.university.ecs.lab.radsource.rad.analyzer.SpringClientAnalyzer;
import edu.university.ecs.lab.radsource.rad.context.RestEntityContext;
...
/**
 * This class constructs a {@link RestEntityContext}. It takes a list of JavaAssist CtClass as
 * input.
 *
 * @author Dipta Das
 */
...
public class RestEntityService {
  ...
  public RestEntityContext getRestEntityContext(
      List<CtClass> allClasses, String path, String serviceDNS, Properties properties) {
    ...
    for (CtClass ctClass : allClasses) {
      ...
      restEntityContext
          .getRestEntities()
          .addAll(springClientAnalyzer.getRestEntity(ctClass, properties));
  ...
  private void populateDefaultProperties(
      RestEntity restEntity, String path, String serviceDNS, Properties properties) {
