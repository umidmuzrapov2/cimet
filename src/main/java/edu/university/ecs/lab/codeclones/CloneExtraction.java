...
//    JsonObject jout = MsFileUtils.constructJsonClonesSystem(scanner.nextLine(), "0.0.1", clonesMap);
//
//    String outputName =
//        outputPath + File.separator + "code-clones-output-[" + (new Date()).getTime() + "].json";
...
//      try {
//        String discoverPath =
//            System.getProperty(SYS_USER_DIR) + File.separator + clonePath + File.separator + path;
//
