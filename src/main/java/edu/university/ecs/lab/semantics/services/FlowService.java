...
//                                    Optional<Class> repositoryClass =
...
//            Class repository, MethodCall RepositoryMethodCall) {
...
//     */
//    private Optional<Class> findRepositoryClass(Field ServiceRepositoryField) {
...
//            Class Service, MethodCall repositoryMethodCall) {
//        return Cache.FieldList.stream()
//                .filter(
//                        n ->
...
//            Class Service, Method ServiceMethod) {
//        return Cache.MethodCallList.stream()
//                .filter(
//                        n ->
//                                n.getId().getPath().equals(Service.getId().getPath())
//                                        &&
...
//            Class Service, MethodCall controllerServiceMethodCall) {
//        return Cache.MethodList.stream()
//                .filter(
//                        n ->
//                                n.getId().getPath().equals(Service.getId().getPath())
//                                        &&
...
//        return Cache.RestCallList.stream()
//                .filter(
//                        n ->
...
//     */
//    public Class findController(Flow Flow) {
//        return Cache.ClassList.stream()
//                .filter(
//                        n ->
//                                n.getId()
//                                        .getPath()
//                                        .equals(Flow.getControllerMethod().getId().getPath()))
//                .findFirst()
//                .get();
//    }
//
