...
/**
 * Class holding static functionality for crawling through root file directory and tagging files
 * then storing them in cache
 */
public class ProcessFiles {

  /**
   * This function crawls through every repo iteratively under projectDir's (root) path and tags the
   * role of the file, initializes an MsID object then calls visit method's to extract further data
   *
  ...
  /**
   * This function first parses all modules (microservices) then loads their names in cache and
   * lastly calls processFile on the root
   *
