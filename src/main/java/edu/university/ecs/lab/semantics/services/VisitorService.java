...
/**
 * Service for processing files and storing information
 * relevant to one microservice system. Therefore, a new
 * visitor service should be invoked for each system.
 */
@AllArgsConstructor
