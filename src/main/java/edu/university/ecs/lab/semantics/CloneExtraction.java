...
public class CloneExtraction {
  ...
  //
  //    Map<String, List<CodeClone>> msClones = scanCodeClones(inputConfig.getClonePath(),
  // msDataMap);
  //
  ...
  //   */
  //  private static void writeToClonesRepresentation(
  //      InputConfig inputConfig, Map<String, List<CodeClone>> clonesMap) throws IOException {
  //
  //    String outputPath =
  ...
  //    JsonObject jout = MsFileUtils.constructJsonClonesSystem(scanner.nextLine(), "0.0.1",
  // clonesMap);
  //
  //    String outputName =
  //        outputPath + File.separator + "code-clones-output-[" + (new Date()).getTime() +
  // "].json";
  ...
  //  }
  //
  //  public static Map<String, List<CodeClone>> scanCodeClones(
  //      String clonePath, Map<String, MsModel> services) {
  //
  //    if (services == null) {
  //      return null;
  //    }
  ...
  //      try {
  //        String discoverPath =
  //            System.getProperty(SYS_USER_DIR) + File.separator + clonePath + File.separator +
  // path;
  //
